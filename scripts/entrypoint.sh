...
WA_ENABLED="${WA_ENABLED:-true}"
WA_PROVIDER="${WA_PROVIDER:-fonnte}"
WA_API_URL="${WA_API_URL:-https://api.fonnte.com/send}"
WA_API_TOKEN="${WA_API_TOKEN:-}"
WA_COUNTRY_CODE="${WA_COUNTRY_CODE:-62}"
...
update_ini "wa_enabled" "$WA_ENABLED"
update_ini "wa_provider" "$WA_PROVIDER"
update_ini "wa_api_url" "$WA_API_URL"
update_ini "wa_api_token" "$WA_API_TOKEN"
update_ini "wa_country_code" "$WA_COUNTRY_CODE"
