...
func totalSWFromSumRW(normAge int, sumRW int) (int, bool) {
	...
	table := map[string][]bucket{
		...
		"19-20": {
			{171, 130}, {161, 127}, {151, 123}, {141, 119}, {131, 116},
			{121, 112}, {111, 108}, {101, 104}, {91, 101}, {81, 97},
			{71, 93}, {61, 90}, {51, 86}, {41, 82}, {31, 79},
			{21, 75}, {11, 71}, {1, 67},
		},
		"21-25": {
		...
		"31-35": {
			{171, 133}, {161, 129}, {151, 125}, {141, 121}, {131, 118}, {121, 114}, {111, 110}, {101, 107},
			{91, 103}, {81, 99}, {71, 96}, {61, 92}, {51, 88}, {41, 84}, {31, 81}, {21, 77}, {11, 73}, {1, 70},
		},
		"36-40": {
